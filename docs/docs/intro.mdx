...
Now using MaticPlasmaClient we can do transaction using plasma bridge. The client contains different apis to help you with the transaction.
These API are covered in [Plasma API](/docs/plasma/new-matic/).
...
Now using MaticPoSClient we can do transaction using POS bridge. The client contains different apis to help you with the transaction.
These API are covered in [POS API](/docs/pos/new-matic/).
