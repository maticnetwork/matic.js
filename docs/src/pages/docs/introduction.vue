<template><Layout title='Introduction' description='Introduction to maticjs' keywords='maticjs, introduction, contract, polygon, sdk' contentSrc='/home/warrior/projects/opensource/matic.js/docs/content/docs/introduction.md'><p>The <a href="https://github.com/maticnetwork/matic.js/"><code>@matic.js</code></a> client library makes it easy for developers, who may not be deeply familiar with smart contract development, to interact with the various components of Matic Network.</p>
