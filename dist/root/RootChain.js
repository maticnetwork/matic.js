...
var RootChain_json_1 = __importDefault(require("matic-protocol/contracts-core/artifacts/RootChain.json"));
...
var RootChain = /** @class */ (function (_super) {
    ...
    function RootChain(rootChain, web3Client) {
        var _this = _super.call(this, web3Client) || this;
        _this.rootChain = new _this.web3Client.parentWeb3.eth.Contract(RootChain_json_1.default.abi, rootChain);
        return _this;
    }
    ...
    RootChain.prototype.getRawContract = function () {
