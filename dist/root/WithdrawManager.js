...
var WithdrawManager = /** @class */ (function (_super) {
    ...
    WithdrawManager.prototype.burnERC721Token = function (token, tokenId, options) {
        return this.wrapWeb3Promise(this.getERC721TokenContract(token)
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.web3Client.send(this.erc721Predicate.methods.startExitForMintWithTokenURITokens(payload, mint), options)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        // note that these calls will be simultaneous
                        _a.sent();
                        return [2 /*return*/, this.web3Client.send(this.erc721Predicate.methods.startBulkExitForMintWithTokenURITokens(ethereumjs_util_1.default.rlp.encode(payloads), ethereumjs_util_1.default.rlp.encode(mints)), options)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.getERC721TokenContract(burnReceipt.to).getPastEvents('Transfer', {
