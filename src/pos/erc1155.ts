...
import { POSERC1155DepositBatchParam, POSERC1155DepositParam, POSERC1155TransferParam, TYPE_AMOUNT } from "../types";
...
export class ERC1155 extends POSToken {
    ...
    private approve_(predicateAddressPromise: Promise<string>, option: ITransactionOption) {
